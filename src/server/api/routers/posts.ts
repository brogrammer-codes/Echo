...
export const postRouter = createTRPCRouter({
  ...
  create: privateProcedure.input(z.object({ title: z.string().min(1).max(100), url: z.string().max(255).optional(), echo: z.string().min(1).max(50), description:z.string().max(50).optional()})).mutation(async ({ ctx, input }) => {
